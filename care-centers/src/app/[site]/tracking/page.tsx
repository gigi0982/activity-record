...
export default function TrackingPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 pb-24">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">✓ 執行追蹤</h1>

            <div className="bg-white rounded-xl shadow-sm p-8 text-center">
                <div className="text-6xl mb-4">🚧</div>
                <h2 className="text-xl font-bold text-gray-700 mb-2">功能開發中</h2>
                <p className="text-gray-500">執行追蹤功能即將推出</p>
                <p className="text-sm text-gray-400 mt-2">此功能將追蹤評鑑改善事項的執行進度</p>
            </div>
